...
def load_policies(policy_factory: PolicyFactory):
    try:
        ...
        for policy_module_name in ["token_based_policies.authlib_flask_oauth2_policy"]:
            policy = __get_class(auth_type, policy_module_name)
        ...
        for policy_module_name in ["super_admin_policy", "scope_based_policy"]:
            policy = __get_class(auth_type, policy_module_name)
...
def __get_class(auth_type, policy_module_name):
